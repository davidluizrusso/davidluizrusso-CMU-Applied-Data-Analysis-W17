...
With the exception of the variable $chas$, each predictor is a significant predictor of crime rate. This can be seen in the chart below which plots p-value for the predictor as a function of model. 
